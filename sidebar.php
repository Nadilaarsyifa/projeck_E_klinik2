                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav nav-pills flex-column justify-content-end flex-grow-1">
                        ...
                        <?php if ($hasil['role'] == 'petugas klinik') { ?>
                            <li class="nav-item">
                                <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x'] == 'datamedis_mahasiswa') ? 'active link-light' : 'link-dark'; ?>"
                                    href="datamedis_mahasiswa"><i class="bi bi-clipboard2-pulse"></i> Data Medis</a>
                            </li>
                        <?php } ?>
                        ...
                        <?php if ($hasil['role'] == 'admin') { ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x'] == 'jadwal_petugas') ? 'active link-light' : 'link-dark'; ?>"
                                    href="jadwal_petugas"><i class="bi bi-clipboard-data"></i> Jadwal Dokter</a>
                            </li>
                            <li class="nav-item">
